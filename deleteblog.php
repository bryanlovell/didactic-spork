<?php
	...
	if (isset($_GET['delblog'])) {
		...
		$query = "DELETE FROM blog_entry WHERE blog_ID = '".$_GET['delblog']."'";
                    ...
                    <div class="blog-entry">
						<?php
							while ($row = mysqli_fetch_array($result)) {
								...
								echo "<u><h6>Posted by ".($row['id_name'])."</h6></u>";
								echo '<a href="deleteblog.php?delblog='.$row['blog_ID'].'><button class="btn btn-primary rounded-0 px-3 px-5">Delete this blog</button></a><br /><br />';
							}
						?>
                    </div>
