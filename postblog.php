<?php
	...
	$query = "SELECT first_name,last_name FROM engineer_users";
  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
			...
			<div class="row">
                <div class="col-md-12 form-group">
                    <label for="tel">Context</label><br />
                    <textarea name="entry" class="form-control form-control-lg" cols="120" rows="10">
					</textarea>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <input type="submit" name="postBlog" value="Post Blog" class="btn btn-primary rounded-0 px-3 px-5">
                </div>
            </div>
                ...
                <?php
					if (isset($_POST['postBlog'])){
						if (!empty($_POST['title']) && !empty($_POST['entry'])) {
							...
							$query = ("INSERT INTO blog_entry (id_name,blog_name,content) VALUES ('$id','$title','$entry')");
							
							mysqli_query($db,$query);
							
							echo 'Your blog has been posted successfully!';
						} else {
							if (empty($_POST['title'])){
								echo '<p style="color:red;">Please fill in your title</p>';
							} else {
								echo '<p style="color:red;">There is no context in your blog!</p>';
							}
						}
					}
				?>
