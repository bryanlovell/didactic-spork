<?php
	...
	$query = "SELECT * FROM blog_entry ORDER BY blog_id DESC";
                    ...
                    <div class="blog-entry">
						<?php
							while ($row = mysqli_fetch_array($result)) {
								echo "<h3>".($row['blog_name'])."</h3><br />";
								echo "<p>".($row['content'])."</p>";
								echo "<u><h6>Posted by ".($row['id_name'])."</h6></u><br />";
							}
						?>
                    </div>
						...
						<?php
							if (isset($_SESSION['login'])){
								if ($_SESSION['id'] == 'admin'){
									echo '<a href="postblog.php"><button class="btn btn-primary rounded-0 px-3 px-5">Post Blog</button></a>';
									echo '<a href="deleteblog.php"><button class="btn btn-primary rounded-0 px-3 px-5">Delete Blog</button></a>';
								} else {
									echo '<a href="postblog.php"><button class="btn btn-primary rounded-0 px-3 px-5">Post Blog</button></a>';
								}
							} else {
